...
public partial class NorthwindPubsDbContext : DbContext
{
    public NorthwindPubsDbContext(DbContextOptions<NorthwindPubsDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__jobs__6E32B6A599DBB82E");
